...
import bwie.com.yikezhongtwo.view.activity.WodeShoucangActivity;
...
public class Shoucang_Liebiao_Adapter extends RecyclerView.Adapter<Remen_Tiaomu_Holder>{
    private List<ShoucangLiebiaoBean.DataBean> data;
    private Context context;
    public Shoucang_Liebiao_Adapter(List<ShoucangLiebiaoBean.DataBean> data, Context context) {
    ...
    public void onBindViewHolder(Remen_Tiaomu_Holder holder, int position) {
        ...
        Glide.with(context).load(data.get(position).getUser().getIcon()).into(holder.tuijianTouxiang);
