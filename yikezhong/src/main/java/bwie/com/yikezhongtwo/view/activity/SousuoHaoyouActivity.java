...
import bwie.com.yikezhongtwo.utils.JsonParser;

public class SousuoHaoyouActivity extends AppCompatActivity {

    @BindView(R.id.jiantou)
    ImageView jiantou;
    @BindView(R.id.souxuo_fanhui)
    TextView souxuoFanhui;
    //显示听写结果
    @BindView(R.id.suosuo_shuru)
    EditText suosuoShuru;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sousuo_haoyou);
        ButterKnife.bind(this);
        initDate();
    }

    @OnClick({R.id.jiantou, R.id.souxuo_fanhui, R.id.huatong, R.id.sousuo_quxiao})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.jiantou:
                finish();
                break;
            case R.id.souxuo_fanhui:
                finish();
                break;
            case R.id.huatong:
                suosuoShuru.setText("");
    ...
    private void initDate() {
        ...
        SpeechUtility.createUtility(this, "appid=5ae41c3d");
    ...
    private void printResult(RecognizerResult results) {
        ...
        suosuoShuru.setText(resultBuffer.toString());
    }
